...
def compute_days_between_dates(original_date, now):
    ...
    dt = date1 - date2
    days = int(dt.total_seconds() / 60 / 60 / 24)  # total_seconds() converts days, hours, etc. into seconds.
    return days
...
def main():  # Just to organize thoughts. There's no convention for using main.
    print_header()
